<head>
    ...
    <meta name=description content="Profile report generated by YData! Visit us at https://ydata.ai">
    <meta name=author content="YData.">
    ...
    */
    ...
    <style>
        ...
        table.correlation-table {
            width: 98%
                /* To avoid an unnecessary overflow. */
        }
